...
public class TbPrdFobRecord extends UpdatableRecordImpl<TbPrdFobRecord> implements Record10<Integer, Integer, Integer, Integer, Double, Double, Double, String, String, String> {
    ...
    @Override
    public Row10<Integer, Integer, Integer, Integer, Double, Double, Double, String, String, String> valuesRow() {
    ...
    @Override
    public TbPrdFobRecord value3(Integer value) {
        setRangeStart(value);
        return this;
    }

    @Override
    public TbPrdFobRecord value4(Integer value) {
        setRangeEnd(value);
        return this;
    }

    @Override
    public TbPrdFobRecord value5(Double value) {
        setTradingPrice(value);
        return this;
    }

    @Override
    public TbPrdFobRecord value6(Double value) {
        setSupplyRate(value);
        return this;
    }

    @Override
    public TbPrdFobRecord value7(Double value) {
    ...
    @Override
    public TbPrdFobRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Double value5, Double value6, Double value7, String value8, String value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TbPrdFobRecord(Integer fobSeq, Integer productSeq, Integer rangeStart, Integer rangeEnd, Double tradingPrice, Double supplyRate, Double exposureSupplyRate, String option_2, String option_3, String delYn) {
        super(TbPrdFob.TB_PRD_FOB);
