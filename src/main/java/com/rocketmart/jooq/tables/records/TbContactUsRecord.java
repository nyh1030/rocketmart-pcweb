...
public class TbContactUsRecord extends UpdatableRecordImpl<TbContactUsRecord> implements Record7<Integer, String, String, String, String, String, Timestamp> {

    private static final long serialVersionUID = 1787783975;
    ...
    public Field<Integer> field1() {
        return TbContactUs.TB_CONTACT_US.CONTACT_SEQ;
    }

    @Override
    public Field<String> field2() {
        return TbContactUs.TB_CONTACT_US.USR_NM;
    }

    @Override
    public Field<String> field3() {
        return TbContactUs.TB_CONTACT_US.EMAIL;
    }

    @Override
    public Field<String> field4() {
        return TbContactUs.TB_CONTACT_US.COMPANY_NM;
    }

    @Override
    public Field<String> field5() {
        return TbContactUs.TB_CONTACT_US.SUBJECT;
    }

    @Override
    public Field<String> field6() {
        return TbContactUs.TB_CONTACT_US.MESSAGE;
    }

    @Override
    public Field<Timestamp> field7() {
        return TbContactUs.TB_CONTACT_US.REG_TS;
    }
    ...
    @Override
    public TbContactUsRecord value1(Integer value) {
        setContactSeq(value);
        return this;
    }

    @Override
    public TbContactUsRecord value2(String value) {
        setUsrNm(value);
        return this;
    }

    @Override
    public TbContactUsRecord value3(String value) {
        setEmail(value);
        return this;
    }

    @Override
    public TbContactUsRecord value4(String value) {
        setCompanyNm(value);
        return this;
    }

    @Override
    public TbContactUsRecord value5(String value) {
        setSubject(value);
        return this;
    }

    @Override
    public TbContactUsRecord value6(String value) {
        setMessage(value);
        return this;
    }

    @Override
    public TbContactUsRecord value7(Timestamp value) {
        setRegTs(value);
        return this;
    }

    @Override
    public TbContactUsRecord values(Integer value1, String value2, String value3, String value4, String value5, String value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    /**
     * Create a detached TbContactUsRecord
     */
    public TbContactUsRecord() {
        super(TbContactUs.TB_CONTACT_US);
    }

    /**
     * Create a detached, initialised TbContactUsRecord
     */
    public TbContactUsRecord(Integer contactSeq, String usrNm, String email, String companyNm, String subject, String message, Timestamp regTs) {
        super(TbContactUs.TB_CONTACT_US);
