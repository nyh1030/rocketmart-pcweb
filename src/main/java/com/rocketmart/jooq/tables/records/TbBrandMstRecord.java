...
public class TbBrandMstRecord extends UpdatableRecordImpl<TbBrandMstRecord> implements Record13<Integer, String, Integer, String, String, String, String, String, String, String, Timestamp, String, Timestamp> {

    private static final long serialVersionUID = -1714172212;
    ...
    @Override
    public Row13<Integer, String, Integer, String, String, String, String, String, String, String, Timestamp, String, Timestamp> valuesRow() {
    ...
    @Override
    public TbBrandMstRecord value11(Timestamp value) {
        setRegTs(value);
        return this;
    }

    @Override
    public TbBrandMstRecord value12(String value) {
        setUpdUsrId(value);
        return this;
    }

    @Override
    public TbBrandMstRecord value13(Timestamp value) {
        setUpdTs(value);
        return this;
    }

    @Override
    public TbBrandMstRecord values(Integer value1, String value2, Integer value3, String value4, String value5, String value6, String value7, String value8, String value9, String value10, Timestamp value11, String value12, Timestamp value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TbBrandMstRecord(Integer brandSeq, String brandNm, Integer brandLogoAfileSeq, String brandOwnership, String brandHomepageUrl, String brandYoutubeUrl, String brandInstagramUrl, String brandCerify, String brandIntroduction, String regUsrId, Timestamp regTs, String updUsrId, Timestamp updTs) {
        super(TbBrandMst.TB_BRAND_MST);
