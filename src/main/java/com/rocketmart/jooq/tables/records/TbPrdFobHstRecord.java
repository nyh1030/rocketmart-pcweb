...
public class TbPrdFobHstRecord extends UpdatableRecordImpl<TbPrdFobHstRecord> implements Record6<Integer, Integer, String, Timestamp, String, Timestamp> {
    ...
    @Override
    public Row6<Integer, Integer, String, Timestamp, String, Timestamp> valuesRow() {
    ...
    @Override
    public TbPrdFobHstRecord value3(String value) {
        setRegUsrId(value);
        return this;
    }

    @Override
    public TbPrdFobHstRecord value4(Timestamp value) {
        setRegTs(value);
        return this;
    }

    @Override
    public TbPrdFobHstRecord value5(String value) {
        setUpdUsrId(value);
        return this;
    }

    @Override
    public TbPrdFobHstRecord value6(Timestamp value) {
        setUpdTs(value);
        return this;
    }

    @Override
    public TbPrdFobHstRecord values(Integer value1, Integer value2, String value3, Timestamp value4, String value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TbPrdFobHstRecord(Integer fobHstSeq, Integer productSeq, String regUsrId, Timestamp regTs, String updUsrId, Timestamp updTs) {
        super(TbPrdFobHst.TB_PRD_FOB_HST);
