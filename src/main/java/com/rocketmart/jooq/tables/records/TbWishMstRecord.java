...
public class TbWishMstRecord extends UpdatableRecordImpl<TbWishMstRecord> implements Record7<Integer, Integer, String, String, Timestamp, String, Timestamp> {

    private static final long serialVersionUID = 2009637991;
    ...
    @Override
    public TbWishMstRecord value5(Timestamp value) {
        setRegTs(value);
        return this;
    }

    @Override
    public TbWishMstRecord value6(String value) {
        setUpdUsrId(value);
        return this;
    }

    @Override
    public TbWishMstRecord value7(Timestamp value) {
        setUpdTs(value);
        return this;
    }

    @Override
    public TbWishMstRecord values(Integer value1, Integer value2, String value3, String value4, Timestamp value5, String value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TbWishMstRecord(Integer wishSeq, Integer productSeq, String askYn, String regUsrId, Timestamp regTs, String updUsrId, Timestamp updTs) {
        super(TbWishMst.TB_WISH_MST);
