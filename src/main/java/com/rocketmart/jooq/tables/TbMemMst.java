...
public class TbMemMst extends TableImpl<TbMemMstRecord> {
    ...
    private static final long serialVersionUID = -993283658;
     ...
     */
    public final TableField<TbMemMstRecord, Integer> MEM_SEQ = createField(DSL.name("MEM_SEQ"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "회원정보 일련번호");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TB_MEM_MST_IDX_MEM_SEQ);
    }
